"""
Support for installing and building the "wheel" binary package1 format.
"""
...
def check_compatibility(version, name):
    ...
    name: name of wheel or package1 to raise exception about
...
class Wheel(object):
    ...
    # TODO: Maybe move the class into the models sub-package1
