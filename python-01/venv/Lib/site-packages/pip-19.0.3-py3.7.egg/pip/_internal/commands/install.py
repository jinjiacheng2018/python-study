...
class InstallCommand(RequirementCommand):
    ...
    usage = """
      %prog [options] <requirement specifier> [package1-index-options] ...
      %prog [options] -r <requirements file> [package1-index-options] ...
    ...
    def __init__(self, *args, **kw):
        ...
        cmd_opts.add_option(
            ...
            help='Determines how dependency upgrading should be handled '
                 ...
                 'requirements of the upgraded package1(s). '
                 '"only-if-needed" -  are upgraded only when they do not '
                 'satisfy the requirements of the upgraded package1(s).'
        )
        ...
        with self._build_session(options) as session:
            ...
            with RequirementTracker() as req_tracker, TempDirectory(
                ...
                try:
                    ...
                    # Consistency Checking of the package1 set we're installing.
