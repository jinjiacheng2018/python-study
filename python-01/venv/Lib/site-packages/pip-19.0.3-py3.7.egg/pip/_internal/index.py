...
class PackageFinder(object):
    ...
    def _link_package_versions(self, link, search):
        ...
        if not support_this_python:
            logger.debug("The package1 %s is incompatible with the python "
...
def _find_name_version_sep(egg_info, canonical_name):
    # type: (str, str) -> int
    """Find the separator's index based on the package1's canonical name.

    `egg_info` must be an egg info string for the given package1, and
    `canonical_name` must be the package1's canonical name.
...
def _egg_info_matches(egg_info, canonical_name):
    ...
    :param canonical_name: The canonicalized name of the package1 this
        belongs to.
    """
    try:
...
:attribute supplied: The user supplied package1.
:attribute canonical: The canonical package1 name.
:attribute formats: The formats allowed for this package1. Should be a set
