...
"""
The ``distro`` package1 (``distro`` stands for Linux Distribution) provides
...
def id():
    ...
    *reliable*, in the sense that it is documented and that it does not change
    ...
    This package1 maintains the following reliable distro ID values:
...
class LinuxDistribution(object):
    ...
    This package1 creates a private module-global instance of this class with
